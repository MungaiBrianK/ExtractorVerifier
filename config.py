...
# Configuration for Azure Document Intelligence as read from .env file ---
...
MONGO_VERIFICATION_LOGS_COLLECTION_NAME = os.environ.get("MONGO_VERIFICATION_LOGS_COLLECTION", "verification_logs") 

# --- Flask Session Secret Key (REQUIRED for Flask-Login) ---
# A strong, random key generated for production using os.urandom(24).hex()
SECRET_KEY = os.environ.get("SECRET_KEY", "your_insecure_default_secret_key_change_this")

# Initial checks for credentials and configurations relient solely on Render's env vars)
